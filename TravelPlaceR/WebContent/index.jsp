...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="logo">
        <h1><a href="index.jsp"><span>Travel Place Recommendation</span> <small>A Personalize Recommendation System for Tourists</small></a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
        <div id="coin-slider"> 
        <a href="#"><img src="images/t6.jpg" width="960px" height="960px" alt="" /><span>
        <big></big><br /></span></a>
         <a href="#"><img src="images/t2.jpg" width="960" height="360" alt="" /><span><big></big><br />
          </span></a> <a href="#"><img src="images/t1.jpg" width="360" height="160" alt="" /><span><big></big><br />
          </span></a> </div>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Travel Place Recommendation</span></h2>
          <div class="clr"></div>
...
<p>Today when we want to plan a trip for holidays or general visit, very first we take a help from travel agencies then we need to plan according to travel agencies. But, because of this we face some difficulties like our vacation is start but travel agency package date is in the end of our holiday or in working time. Because of this limitation sometime we change the plan or drop the plan. In our system we propose a system in which user define its holiday starting date and ending date then system provide some recommendation like cost of package, points according to season, schedule, hotels and different packages. Tourist will filter according to its need.</p>          </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="ex_menu">
            <li><a href="#">Akash Shinde</a><br />
              BE </li>
            <li><a href="#">Ravikant Sirsat</a><br />
             BE </li>
             <li><a href="#">Tejas Jagdale</a><br />
             BE </li>             
             <li><a href="#">Aditya Dhore</a><br />
             BE </li>
             <li><a href="#">Prof. Mahendra Salunke</a><br />
             Guide </li>             
          </ul>
        </div>
      </div>
