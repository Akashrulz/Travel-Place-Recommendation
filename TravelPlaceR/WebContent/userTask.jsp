  ...
  <div class="content">
    <div class="content_resize">
      ...
      <br></br>
            ...
            <h2 style="font-size: 2em;"><a href="viewTask.jsp">View My Task</a></h2>
      </div>
      <form action="UserAddTask" method="post">
       <table cellpadding="5" cellspacing="5" border="0" width="600" >
				<tr>
					<td colspan="3" bgcolor="1D810E"><span style="color: #FFFFFF;font-weight: bold;">
					Add Task to Location </span></td>
				</tr>
				<tr>
				...
				<tr>
 				<td><strong><font color="black">Reminder</font></strong></td>
 				<td><strong><font color="black">:</font></strong></td>
				<td><input type="text" name="reminder" placeholder="add text reminder"></input></td>
				</tr>
