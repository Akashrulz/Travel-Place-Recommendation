...
%>
       ...
       <table cellpadding="5	" cellspacing="5" border="0" width="600" >
         ...
         <h2 style="font-size: 18px">
                  Add Places:-
                  <br />
                  <a href="addPlaces.jsp?locationId=<%=locationId %>">Devotional</a> |
         <a href="addPlaces.jsp?locationId=<%=locationId %>"> Historic</a> |
         <a href="addPlaces.jsp?locationId=<%=locationId %>"> Natural</a> |
         <a href="addPlaces.jsp?locationId=<%=locationId %>"> Entertainment</a> |
         <a href="addPlaces.jsp?locationId=<%=locationId %>"> Adventours</a> |
